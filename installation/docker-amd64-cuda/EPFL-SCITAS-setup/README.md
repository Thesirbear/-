...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/ASVSPOOF2019_HW:amd64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/ASVSPOOF2019_HW:amd64-cuda-root-latest
```
