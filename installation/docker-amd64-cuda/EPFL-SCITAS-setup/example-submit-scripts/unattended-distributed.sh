...
export PROJECT_ROOT_AT=$HOME/projects/ASVSPOOF2019_HW/run
export PROJECT_NAME=ASVSPOOF2019_HW
export PACKAGE_NAME=ASVSPOOF2019_HW
export SLURM_ONE_ENTRYPOINT_SCRIPT_PER_NODE=1
export WANDB_API_KEY_FILE_AT=$HOME/.wandb-api-key

srun \
  --container-image=$CONTAINER_IMAGES/claire+moalla+ASVSPOOF2019_HW+amd64-cuda-root-latest.sqsh \
  --container-mounts=\
/etc/slurm,\
$PROJECT_ROOT_AT,\
$SCRATCH,\
$WANDB_API_KEY_FILE_AT \
  ...
  bash -c 'sleep 60; python -m ASVSPOOF2019_HW.template_experiment some_arg=LOCALID-$SLURM_LOCALID-PROCID-$SLURM_PROCID'
